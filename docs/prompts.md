...
- propose_focus_area_update: Create, progress, regress, or resolve a focus area based on evidence this session — when this session gives real evidence that a focus area improved/regressed, or a new recurring pattern (2+ occurrences across sessions) deserves focus.
