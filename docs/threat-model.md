...
| A2 | Users' AI provider API keys | AES-256-GCM ciphertext in Postgres (key from the user's unlock phrase via scrypt); encrypted, HMAC-named entry in Redis while unlocked |
